...
export default function LandingPage() {
  ...
  const handleCreateAccount = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    const createUserDto = {
      ...
      username: formData.get('name')?.toString().toLowerCase().replace(/\s+/g, '') || '',
    ...
    try {
      const response = await axios.post('http://localhost:3001/user/create', createUserDto);
  ...
  const handleLogin = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      const response = await axios.post('http://localhost:3001/auth/login', loginDto);
    ...
    <div className="min-h-screen flex flex-col bg-white">
        ...
        <div className="flex items-center space-x-12">
          <div className="flex flex-col items-start leading-none">
            <div className="flex items-baseline">
              <span className="font-serif text-6xl font-bold text-primary -mr-2">A</span>
              <span className="font-serif text-3xl font-bold text-primary">rada</span>
            </div>
            <div className="flex items-baseline -mt-2">
              <span className="font-serif text-6xl font-bold text-primary -mr-2">C</span>
              <span className="font-serif text-3xl font-bold text-primary">hallenges</span>
            </div>
          </div>
        </div>
      ...
      <main className="flex-1 flex relative overflow-hidden">
        <div className="flex-1 flex flex-col justify-between p-8 lg:p-16 relative z-10">
          <div className="max-w-2xl pt-24 pb-16">
            ...
            <div className="inline-block bg-yellow-50 px-4 py-2 rounded-md mb-8">
              <p className="text-xl text-gray-800 font-medium">Promote Clean Air in Your Home</p>
            </div>
            <p className="text-lg text-gray-700 max-w-xl mb-10 leading-relaxed">
              Explore our eco-friendly plant designs that enhance your space while promoting cleaner, fresher air indoors. Each plant is selected to improve indoor air quality naturally, creating a healthier environment for you.
            </p>
            <div className="flex space-x-4">
              ...
              <Button variant="outline" className="border-leafy-button-green text-leafy-button-green hover:bg-leafy-button-green hover:text-white rounded-lg px-8 py-3 text-lg font-medium transition-colors flex items-center space-x-2">
                <span>Explore</span>
        ...
        <div className="absolute right-0 top-0 bottom-0 w-20 bg-white flex flex-col items-center justify-center space-y-8 text-leafy-social text-sm font-semibold uppercase tracking-widest transform rotate-90 origin-bottom-right translate-x-1/2 translate-y-1/2 z-30">
          <a href="#" className="hover:text-primary transition-colors whitespace-nowrap">Facebook</a>
          <a href="#" className="hover:text-primary transition-colors whitespace-nowrap">Instagram</a>
          <a href="#" className="hover:text-primary transition-colors whitespace-nowrap">Twitter</a>
        </div>
      </main>
      ...
      <section className="py-20 md:py-28 bg-white px-8 lg:px-16">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-12 text-center">
          <div>
            <h4 className="text-lg font-medium text-gray-700 mb-4">Challenges Completed</h4>
            <p className="text-6xl font-extrabold text-primary mb-4">500+</p>
            <p className="text-sm text-gray-600 max-w-xs mx-auto">
              We've successfully completed over 500 challenges, making a tangible difference worldwide.
            </p>
          </div>
          <div>
            <h4 className="text-lg font-medium text-gray-700 mb-4">Active Participants</h4>
            <p className="text-6xl font-extrabold text-primary mb-4">14K</p>
            <p className="text-sm text-gray-600 max-w-xs mx-auto">
              Join our growing community of over 14,000 passionate individuals making an impact.
            </p>
          </div>
          <div>
            <h4 className="text-lg font-medium text-gray-700 mb-4">Solutions Implemented</h4>
            <p className="text-6xl font-extrabold text-primary mb-4">1500+</p>
            <p className="text-sm text-gray-600 max-w-xs mx-auto">
              Our community has implemented over 1500 innovative solutions to global challenges.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="space-y-12">
            <div className="max-w-xl">
              ...
              <p className="text-lg text-gray-700 leading-relaxed">
                Discover how easy it is to make a difference with Arada Challenges. Our user-friendly process ensures a smooth, hassle-free experience from discovering challenges to seeing your impact.
              </p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="bg-tertiary p-6 rounded-2xl shadow-sm">
                <div className="flex items-center justify-between mb-4">
                  <h4 className="text-xl font-bold text-primary">Discover Challenges</h4>
                  <div className="w-8 h-8 rounded-full bg-primary text-primary-foreground flex items-center justify-center font-bold text-sm">
                    01
                  </div>
                </div>
                <p className="text-gray-700 leading-relaxed">
                  Explore a wide range of environmental and community challenges near you or globally.
                </p>
              </div>
              <div className="bg-tertiary p-6 rounded-2xl shadow-sm">
                <div className="flex items-center justify-between mb-4">
                  <h4 className="text-xl font-bold text-primary">Join the Community</h4>
                  <div className="w-8 h-8 rounded-full bg-primary text-primary-foreground flex items-center justify-center font-bold text-sm">
                    02
                  </div>
                </div>
                <p className="text-gray-700 leading-relaxed">
                  Connect with like-minded individuals and organizations passionate about making a difference.
                </p>
              </div>
              <div className="bg-tertiary p-6 rounded-2xl shadow-sm">
                <div className="flex items-center justify-between mb-4">
                  <h4 className="text-xl font-bold text-primary">Propose Solutions</h4>
                  <div className="w-8 h-8 rounded-full bg-primary text-primary-foreground flex items-center justify-center font-bold text-sm">
                    03
                  </div>
                </div>
                <p className="text-gray-700 leading-relaxed">
                  Share your innovative ideas and solutions to tackle pressing issues effectively.
                </p>
              </div>
              <div className="bg-tertiary p-6 rounded-2xl shadow-sm">
                <div className="flex items-center justify-between mb-4">
                  <h4 className="text-xl font-bold text-primary">Track Your Impact</h4>
                  <div className="w-8 h-8 rounded-full bg-primary text-primary-foreground flex items-center justify-center font-bold text-sm">
                    04
                  </div>
                </div>
                <p className="text-gray-700 leading-relaxed">
                  See your contributions on the global impact map and climb the leaderboard.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-xl max-w-md w-full p-8 relative overflow-hidden">
            ...
            <div className="space-y-6">
              <div>
                <h3 className="text-3xl font-bold text-primary mb-2">Join Us</h3>
                <p className="text-gray-600">Create your account to start making an impact</p>
              </div>
      ...
      {showSignIn && (
        <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-xl max-w-md w-full p-8 relative overflow-hidden">
            ...
            <div className="space-y-6">
              <div>
                <h3 className="text-3xl font-bold text-primary mb-2">Welcome Back</h3>
